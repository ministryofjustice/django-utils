...
from moj_utils.tests.utils import TestCase
from moj_utils.healthchecks import registry


class HealthcheckTestCase(TestCase):
    re_test_app_modules = re.compile(r'^moj_utils\.tests.app(\.|$)')
    ...
    @override_settings(INSTALLED_APPS=['moj_utils', 'moj_utils.tests.app'],
                       HEALTHCHECKS=[])
    ...
    @mock.patch('moj_utils.healthchecks.database_healthcheck')
    ...
    def test_healthcheck_view_with_responses(self):
        ...
        from moj_utils.tests.app.healthchecks import passing_bool_healthcheck, \
    ...
    def test_url_healthcheck(self):
        from moj_utils.healthchecks import UrlHealthcheck
